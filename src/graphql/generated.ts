...
export type CreateSubsribeMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubsribeMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSubsribeDocument = gql`
    mutation CreateSubsribe($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSubsribeMutationFn = Apollo.MutationFunction<CreateSubsribeMutation, CreateSubsribeMutationVariables>;

/**
 * __useCreateSubsribeMutation__
 *
 * To run a mutation, you first call `useCreateSubsribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubsribeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubsribeMutation, { data, loading, error }] = useCreateSubsribeMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubsribeMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubsribeMutation, CreateSubsribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubsribeMutation, CreateSubsribeMutationVariables>(CreateSubsribeDocument, options);
      }
export type CreateSubsribeMutationHookResult = ReturnType<typeof useCreateSubsribeMutation>;
export type CreateSubsribeMutationResult = Apollo.MutationResult<CreateSubsribeMutation>;
export type CreateSubsribeMutationOptions = Apollo.BaseMutationOptions<CreateSubsribeMutation, CreateSubsribeMutationVariables>;
